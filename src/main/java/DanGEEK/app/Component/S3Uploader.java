...
public class S3Uploader {
    ...
    public String putS3(File uploadFile, String fileName) {
        PutObjectResult putObjectResult = amazonS3Client.putObject(new PutObjectRequest(bucket, fileName, uploadFile).withCannedAcl(
    ...
    private Optional<File> convert(MultipartFile file) throws IOException {
        ...
        String dirPath = UUID.randomUUID() + file.getOriginalFilename();
